...
## 🚗 픽커 실주행 — 내일 판 (2026-09-03) · 안내는 [docs/지금/픽커_내일판.md](docs/지금/픽커_내일판.md)
...
- [ ] **수락 후 화면 낱말 실물 대조** — 09-03 캡처 뒤. 특히 「픽업 출발하기」 버튼이
      지금도 있는지 (노하우는 *이 버튼이 돈을 가른다*고 했는데 실물 2026 에서 못 봤다)
