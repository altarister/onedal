...
- [ ] **[기획·필터]** 하한가 마진 — 인성 금액이 경계값에 딱 안 떨어짐(3만 오더→22,900·22,300원).
      하한 필터 1~2천 원 마진 기본 반영 검토. 근거: 노하우 §8-3 (인성퀵 설정 편)
- [ ] **[기획·필터]** 지역별 상차 반경 프리셋 — 서울 시내 5km / 경기 외곽 7~15km.
      근거: 노하우 §8-1 (국면별 반경 분리는 이미 있음, 기본값 근거로)
