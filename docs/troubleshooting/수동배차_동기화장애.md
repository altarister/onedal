...
#### 📄 1. [제품_요구사항.md](file:///Users/seungwookkim/reps/onedal/docs/제품_요구사항.md) (글로벌 기획서)
...
#### 📄 3. [안전모드_구조.md](file:///Users/seungwookkim/reps/onedal/docs/architecture/안전모드_구조.md) (안전 모드 설계서)
...
#### 📄 4. [관제탑_상태_분리.md](file:///Users/seungwookkim/reps/onedal/docs/troubleshooting/관제탑_상태_분리.md) (관제탑 연결 끊김 트러블슈팅)
...
#### 📄 5. [배차_동기화_장애.md](file:///Users/seungwookkim/reps/onedal/docs/troubleshooting/배차_동기화_장애.md) (배차 동기화 실패 트러블슈팅)
...
1. **SSOT 후보**: [안전모드_구조.md](file:///Users/seungwookkim/reps/onedal/docs/architecture/안전모드_구조.md)에 "데스밸리 타이머 전체 아키텍처" 섹션을 신설하여, 3개 타이머의 위치·시간·조건·동작을 한 곳에서 관리
