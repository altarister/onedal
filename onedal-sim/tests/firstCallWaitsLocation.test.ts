...
/**
 * 📍 **첫 콜은 기사님 위치를 받은 뒤에 낸다** (기사님 지시).
 *
 * 시뮬레이터가 켜지자마자 첫 콜을 내면, 서버에서 내 위치를 받기 전의 **기본 자리(경기 광주시)**로
 * 상차 거리를 잰다 — 실제 2.2km 인 상차지가 7.2km 로 적혀 반경 4.55km 에서 떨어지고, 첫 콜을 놓친다
 * (원달앱 로그: 같은 상차지가 첫 콜 7.2km · 나중 콜 2.2km).
 *
