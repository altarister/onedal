...
const BEAUTIFUL_CHURCH = stop('분당구', '경기 성남시 분당구 금곡로 182 아름다운교회', 127.120139, 37.351104);          // 집에서 16.1km
const EMART_BUNDANG    = stop('분당구', '경기 성남시 분당구 불정로 134 이마트 분당점', 127.119758, 37.358797);          // 16.0km
const SOGONGWON        = stop('분당구', '경기 성남시 분당구 서현동 324 소공원어린이공원 개방화장실', 127.13685, 37.379519); // 14.4km
const TIREPRO_SEOHYEON = stop('분당구', '경기 성남시 분당구 돌마로 572 타이어프로 분당서현점', 127.138682, 37.383986);   // 14.3km
const SUDOGOL          = stop('분당구', '경기 성남시 분당구 야탑동 수도골', 127.141754, 37.405639);                     // 14.4km
const BULSAJO_OIL      = stop('중원구', '경기 성남시 중원구 경충대로 2441 디오티디 성남불사조주유소', 127.179635, 37.423321); // 12.0km
const ODBIKE_GWANGJU   = stop('광주시', '경기 광주시 경충대로 1871 오디바이크 광주물류센터', 127.231962, 37.405302);     // 7.0km
const SAE_GWANGJU_GAS  = stop('광주시', '경기 광주시 경충대로 1523 새광주충전소', 127.268235, 37.4043);                 // 4.4km
