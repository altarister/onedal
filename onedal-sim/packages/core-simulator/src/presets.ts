...
export const PRESETS: Record<string, PresetProblem[]> = {
     ...
     *
     *    다마스 단가 616원/km(앱 `activeFilter` 실측)로 검산한 값이다:
     *
     *    | # | 구간 | 직선 | 필요 | 실측 | 시험용 |
     *    |---|---|---|---|---|---|
     *    | 03 | 갈마동→성거읍   |  61.5km | 37,884 | 50,050 | **그대로** |
     *    | 04 | 문지동→가수동   |  89.3km | 55,009 | 38,500 | 67,000 |
     *    | 05 | 오송읍→논현동   | 100.7km | 62,032 | 38,500 | 75,000 |
     *    | 06 | 오송읍→성곡동   |  91.1km | 56,118 | 38,500 | 68,000 |
     *    | 07 | 갈마동→송도동   | 133.4km | 82,175 | 80,000 | 99,000 |
     *    | 09 | 성거읍→경서동   |  89.0km | 54,824 | 46,200 | 66,000 |
     *    | 11 | 성수동→송도동   |  40.5km | 24,948 | 42,300 | **그대로** |
     *    | 12 | 문정동→신도림동 |  21.8km | 13,429 | 30,800 | **그대로** |
     *
     *    필요값의 **1.2배**로 올려 요금 축이 절대 안 걸리게 했다. 라벨에 «(실측 N)» 을
