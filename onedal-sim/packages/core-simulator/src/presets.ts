...
export const PRESETS: Record<string, PresetProblem[]> = {
    ...
    '초월이천': [
        ...
        {
            label: '08 ✖ 요금 · 곤지암성당 → 롯데아울렛 이천 · 6000원',
            pickup: '경충대로543번길 19', dropoff: '프리미엄아울렛로 177-74',
            fare: 6000, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **6000원** — 단가 미달로 떨어진다',
        },
        {
            label: '09 ✖ 요금 · 동원대 → 인삼농협 이천 · 6300원',
            pickup: '경충대로 26', dropoff: '둔터로124번길 160',
            fare: 6300, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **6300원** — 단가 미달로 떨어진다',
        },
        {
            label: '10 ✖ 차종 · 모다아울렛 → 인삼농협 이천 · 25t',
            pickup: '경충대로 907', dropoff: '둔터로124번길 160',
            fare: 152000, vehicleType: '25t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **25t 라서** 떨어져야 한다',
        },
        {
            label: '11 ✖ 요금 · 곤지암성당 → 예스파크 · 6900원',
            pickup: '경충대로543번길 19', dropoff: '도자예술로 72',
            fare: 6900, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **6900원** — 단가 미달로 떨어진다',
        },
        {
            label: '12 ✖ 요금 · 동원대 → 롯데아울렛 이천 · 7200원',
            pickup: '경충대로 26', dropoff: '프리미엄아울렛로 177-74',
            fare: 7200, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **7200원** — 단가 미달로 떨어진다',
        },
        {
            label: '13 ✖ 차종 · 모다아울렛 → 예스파크 · 11t',
            pickup: '경충대로 907', dropoff: '도자예술로 72',
            fare: 155000, vehicleType: '11t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **11t 라서** 떨어져야 한다',
        },
        {
            label: '14 ✖ 요금 · 곤지암성당 → 인삼농협 이천 · 7800원',
            pickup: '경충대로543번길 19', dropoff: '둔터로124번길 160',
            fare: 7800, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **7800원** — 단가 미달로 떨어진다',
        },
        {
            label: '15 ✖ 요금 · 동원대 → 예스파크 · 8100원',
            pickup: '경충대로 26', dropoff: '도자예술로 72',
            fare: 8100, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **8100원** — 단가 미달로 떨어진다',
        },
        {
            label: '16 ✖ 차종 · 모다아울렛 → 롯데아울렛 이천 · 5t',
            pickup: '경충대로 907', dropoff: '프리미엄아울렛로 177-74',
            fare: 158000, vehicleType: '5t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **5t 라서** 떨어져야 한다',
        },
        {
            label: '17 ✖ 요금 · 곤지암성당 → 롯데아울렛 이천 · 8700원',
            pickup: '경충대로543번길 19', dropoff: '프리미엄아울렛로 177-74',
            fare: 8700, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **8700원** — 단가 미달로 떨어진다',
        },
        {
            label: '18 ✖ 요금 · 동원대 → 인삼농협 이천 · 9000원',
            pickup: '경충대로 26', dropoff: '둔터로124번길 160',
            fare: 9000, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **9000원** — 단가 미달로 떨어진다',
        },
        {
            label: '19 ✖ 차종 · 모다아울렛 → 인삼농협 이천 · 3.5t',
            pickup: '경충대로 907', dropoff: '둔터로124번길 160',
            fare: 161000, vehicleType: '3.5t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **3.5t 라서** 떨어져야 한다',
        },
        {
            label: '20 ✖ 요금 · 곤지암성당 → 예스파크 · 9600원',
            pickup: '경충대로543번길 19', dropoff: '도자예술로 72',
            fare: 9600, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **9600원** — 단가 미달로 떨어진다',
        },
        {
            label: '21 ✖ 요금 · 동원대 → 롯데아울렛 이천 · 9900원',
            pickup: '경충대로 26', dropoff: '프리미엄아울렛로 177-74',
            fare: 9900, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **9900원** — 단가 미달로 떨어진다',
        },
        {
            label: '22 ✖ 차종 · 모다아울렛 → 예스파크 · 25t',
            pickup: '경충대로 907', dropoff: '도자예술로 72',
            fare: 164000, vehicleType: '25t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **25t 라서** 떨어져야 한다',
        },
        {
            label: '23 ✖ 요금 · 곤지암성당 → 인삼농협 이천 · 10500원',
            pickup: '경충대로543번길 19', dropoff: '둔터로124번길 160',
            fare: 10500, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **10500원** — 단가 미달로 떨어진다',
        },
        {
            label: '24 ✖ 요금 · 동원대 → 예스파크 · 10800원',
            pickup: '경충대로 26', dropoff: '도자예술로 72',
            fare: 10800, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **10800원** — 단가 미달로 떨어진다',
        },
        {
            label: '25 ✖ 차종 · 모다아울렛 → 롯데아울렛 이천 · 11t',
            pickup: '경충대로 907', dropoff: '프리미엄아울렛로 177-74',
            fare: 167000, vehicleType: '11t', expect: 'BLOCK',
            why: '경로 위 · 요금도 좋다 — **11t 라서** 떨어져야 한다',
        },
        {
            label: '26 ✖ 요금 · 곤지암성당 → 롯데아울렛 이천 · 11400원',
            pickup: '경충대로543번길 19', dropoff: '프리미엄아울렛로 177-74',
            fare: 11400, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **11400원** — 단가 미달로 떨어진다',
        },
        {
            label: '27 ✖ 요금 · 동원대 → 인삼농협 이천 · 11700원',
            pickup: '경충대로 26', dropoff: '둔터로124번길 160',
            fare: 11700, vehicleType: '다마스', expect: 'BLOCK',
            why: '경로 위인데 **11700원** — 단가 미달로 떨어진다',
        },
        {
            label: '28 ⭕ 주행 중 합짐 · 동원대 → 예스파크 · 30박스',
            pickup: '경충대로 26', dropoff: '도자예술로 72',
            fare: 38000, vehicleType: '다마스', expect: 'PASS',
            why: '🔵 **정차했을 때 KEEP.** 상차 곤지암읍·하차 신둔면 둘 다 주행중 우회 1km 안. 누적 90박스',
        },
        {
            label: '29 ✖ 역주행 · 예스파크 → 모다아울렛 · 승용차',
