 ...
 *    **경충대로 한 줄에 아홉이 꿰인다.**
 *
 * ── 서→동 일직선 (좌표는 카카오 실측 2026-09-11) ──
 * ```
 * 출발  분당서울대병원 (127.12322, 37.35191)
 ...
 * ```
 *
 * 🔴 **요금은 20만 고정이다** (볼트 판과 같은 방식) — 요금 축을 꺼서 **«집 방향인가»만**
 *    남긴다. 축을 둘 이상 켜면 무엇 때문에 막혔는지 갈리지 않는다.
 * 🔴 **차종은 승용차(5박스)** — 아홉을 다 잡아도 45박스라 1t(100박스) 안에 든다.
 *    다마스(30박스)면 넷째부터 적재에 막혀 **«집 방향인가»가 아니라 «자리가 있나»를 재게 된다.**
 * ⚠️ **집 주소는 초월역으로 둔다** — 기사님 실제 집을 문제지에 박지 않는다. 같은 읍이라
 *    거리·방향 판정은 같다.
 */
export const BYEONGWON_BOKGWI: PresetProblem[] = [
        {
            label: '① ⭕ 아름다운교회 → 집(초월역)',
            pickup: '경기 성남시 분당구 금곡로 182 아름다운교회',
            pickupFallback: { region: '분당구', addressDetail: '경기 성남시 분당구 금곡로 182 아름다운교회', lon: 127.120139, lat: 37.351104 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '병원 바로 옆(0.3km) — 첫짐으로 가장 가깝다',
        },
        {
            label: '② ⭕ 이마트 분당점 → 집(초월역)',
            pickup: '경기 성남시 분당구 불정로 134 이마트 분당점',
            pickupFallback: { region: '분당구', addressDetail: '경기 성남시 분당구 불정로 134 이마트 분당점', lon: 127.119758, lat: 37.358797 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '정자동 — 아직 분당 안쪽이라 집까지 거리가 거의 그대로다',
        },
        {
            label: '③ ⭕ 소공원어린이공원 개방화장실 → 집(초월역)',
            pickup: '경기 성남시 분당구 서현동 324 소공원어린이공원 개방화장실',
            pickupFallback: { region: '분당구', addressDetail: '경기 성남시 분당구 서현동 324 소공원어린이공원 개방화장실', lon: 127.13685, lat: 37.379519 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '서현 — 여기서부터 동쪽으로 꺾인다',
        },
        {
            label: '④ ⭕ 타이어프로 분당서현점 → 집(초월역)',
            pickup: '경기 성남시 분당구 돌마로 572 타이어프로 분당서현점',
            pickupFallback: { region: '분당구', addressDetail: '경기 성남시 분당구 돌마로 572 타이어프로 분당서현점', lon: 127.138682, lat: 37.383986 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '서현 끝 — 소공원에서 0.6km, 거의 같은 자리다',
        },
        {
            label: '⑤ ⭕ 수도골 → 집(초월역)',
            pickup: '경기 성남시 분당구 야탑동 수도골',
            pickupFallback: { region: '분당구', addressDetail: '경기 성남시 분당구 야탑동 수도골', lon: 127.141754, lat: 37.405639 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '야탑 — 분당의 마지막 지점',
        ...
        {
            label: '⑥ ⭕ 디오티디 성남불사조주유소 → 집(초월역)',
            pickup: '경기 성남시 중원구 경충대로 2441 디오티디 성남불사조주유소',
            pickupFallback: { region: '중원구', addressDetail: '경기 성남시 중원구 경충대로 2441 디오티디 성남불사조주유소', lon: 127.179635, lat: 37.423321 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '경충대로에 올라탔다 — 여기부터 집까지 한 길이다',
        },
        {
            label: '⑦ ⭕ 오디바이크 광주물류센터 → 집(초월역)',
            pickup: '경기 광주시 경충대로 1871 오디바이크 광주물류센터',
            pickupFallback: { region: '광주시', addressDetail: '경기 광주시 경충대로 1871 오디바이크 광주물류센터', lon: 127.231962, lat: 37.405302 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '광주 진입 — 경충대로를 그대로 탄다',
        },
        {
            label: '⑧ ⭕ 새광주충전소 → 집(초월역)',
            pickup: '경기 광주시 경충대로 1523 새광주충전소',
            pickupFallback: { region: '광주시', addressDetail: '경기 광주시 경충대로 1523 새광주충전소', lon: 127.268235, lat: 37.4043 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '집까지 4km — 거의 다 왔다',
        ...
        {
            label: '⑨ ⭕ 노브랜드 광주초월점 → 집(초월역)',
            pickup: '경기 광주시 초월읍 경충대로 1215 노브랜드 광주초월점',
            pickupFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1215 노브랜드 광주초월점', lon: 127.290318, lat: 37.383855 },
            dropoff: '경기 광주시 초월읍 경충대로 1066 초월역',
            dropoffFallback: { region: '초월읍', addressDetail: '경기 광주시 초월읍 경충대로 1066 초월역', lon: 127.299905, lat: 37.373379 },
            fare: 200000, vehicleType: '승용차', expect: 'PASS',
            why: '초월읍 — 집과 같은 읍이다. 우회가 사실상 0',
        },
];
