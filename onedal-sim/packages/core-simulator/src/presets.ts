...
export const PRESETS: Record<string, PresetProblem[]> = {
    ...
    '서현여주': [
        {
            label: '① 첫짐 · 서현 → 여주 가남 · 다마스(30박스)',
            pickup: '중앙공원로39번길 31', dropoff: '본두1길 17-50',
            fare: 70000, vehicleType: '다마스', expect: 'PASS',
            why: '집 앞 0.5km 에서 실어 여주로 — 노선을 정하는 콜. 43.1km · 필요 2.4만',
        },
        {
            label: '② 합짐1 · 초월읍 → 이천 부발(리코마켓팅) · 다마스(30박스)',
            pickup: '경충대로 1241', dropoff: '무촌로 21-97',
            fare: 45000, vehicleType: '다마스', expect: 'PASS',
            why: '🛣️ **서현→가남 경로 위**. 카카오 경로가 «섬말IC → 초월IC → 부발졸음쉼터 → 가남» 으로 가므로 초월·부발이 경유 목록에 든다 (2026-08-25 실측). 누적 60박스',
        },
        {
            label: '③ 합짐2 · 초월읍 → 이천 부발(쿠팡 이천4) · 다마스(30박스)',
            pickup: '경충대로 1241', dropoff: '황무로 1901',
            fare: 42000, vehicleType: '다마스', expect: 'PASS',
            why: '같은 경로 위, 조금 더 뒤에서 내린다. 누적 **90박스** — 여기서 다마스가 더는 안 들어간다',
        },
        {
            label: '④ 복귀 · 여주 가남 → 서현 · 다마스',
            pickup: '본두1길 17-50', dropoff: '분당로263번길 49',
            fare: 75000, vehicleType: '다마스',
            why: '🏠 **복귀콜.** 지금은 가남(43km) → 서현(0km) 이라 **역주행으로 차단되는 것이 정상**이다. 팝업+역주행 면제가 생기면 잡혀야 한다',
        },
        {
            label: '⑤ 복귀 합짐 · 여주 점동 → 분당 정자 · 라보',
            pickup: '송삼로 36', dropoff: '정자일로 242',
            fare: 80000, vehicleType: '라보',
        ...
        },
        {
            ...
            why: '여주 안에서 도는 콜. 팝업에서 «여주 관내» 를 고르면 잡혀야 하는 것',
        },
        {
            label: '⑦ 큰 차 · 초월읍 → 이천 부발(푸디스트) · 5t — 차종 미달',
            pickup: '경충대로 1241', dropoff: '중부대로1763번길 45',
            fare: 200000, vehicleType: '5t', expect: 'BLOCK',
            why: '상차·하차가 **경로 위**(초월→부발)라 다른 축은 다 통과한다 — 오직 **차종**만으로 떨어지는지 보는 콜. 1t 차에 5t 짐은 못 싣는다',
        },
        {
            label: '⑧ 싼 콜 · 초월읍 → 이천 부발 · 다마스 — 단가 미달',
            pickup: '경충대로 1241', dropoff: '중부대로1763번길 80-7',
            fare: 8000, vehicleType: '다마스', expect: 'BLOCK',
            why: '상차·하차가 **경로 위**라 다른 축은 다 통과한다 — 오직 **요금**으로 떨어지는지 보는 콜. 24.6km 에 8천원 (필요 1.36만)',
        },
    ],
...
export const PRESET_MENU: Array<{ key: string; title: string; desc: string }> = [
    { key: '서현여주', title: '🏠 서현(분당) → 이천 → 여주 · 복귀콜 검증',
      desc: '8문제 · 복귀·관내 콜이 들어 있다 (지금은 차단되는 게 정상)' },
