 ...
 *
 * 손으로 대조하면 또 빠뜨린다. 실제로 이 검사로 두 개를 찾았다.
...
/**
 * 🔴 **네 번째 방향 — 아무도 쏘지 않는데 열려 있는 문.**
 *
 * 세 방향만 보면 `update-my-location` · `dispatch-complete` 같은 것을 놓친다.
 * 둘 다 **아무도 쏘지 않는데 열려 있는 문**이고,
...
/**
 * 🍝 **다섯 번째 방향 — «한 사건을 여러 곳이 판단하는가»** (기사님 지시).
 *
