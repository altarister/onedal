 ...
 * 누가: `pnpm db parse` 가 부른다
 * 언제: 새 배차망을 붙인 뒤, 앱이 화면을 제대로 읽었는지 볼 때
 * 어디서: cd onedal-web && pnpm db parse [배차망]
 * 무엇을: 장부의 화면 원문으로 반쪽 읽힘 · 낯선 글자 · 모르는 배지를 찾는다
 * 왜: 폰 로그는 잘리고 3일치만 남지만 장부는 남는다
