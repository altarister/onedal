 ...
 * `orderByNearest` 를 쓴다. 이 도구는 **옛 규칙 «상차 전부 먼저»**와 지금 규칙의 직선 총주행을 나란히 재어,
 * 규칙을 다시 바꾸려 할 때의 숫자를 준다. (기사님 실측: *"곤지암 하차 4.0km · 가남 29.9km 인데 순서가
 * ⑴가남상차 ⑵가남하차 ⑶세종대왕면하차 ⑷곤지암하차(94분) 로 나왔다"* — 옛 규칙의 모습이다)
 *
...
/** 옛 규칙 — 상차 전부 먼저, 각각 최근접 (optimizeWaypoints). 지금 코드가 아니라 견줄 기준이다 */
