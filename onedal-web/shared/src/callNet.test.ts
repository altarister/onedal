...
describe('판(목적지) 그룹 경로 — 콜마다 잡을 당시 목적지를 기억한다 (기사님 설계 2026-09-08)', () => {
     ...
     * 점에서 공백을 줄이는 좋은 방법."* 실측 사고: 복귀 콜들이 잡은 순서대로 뒤에
...
describe('pruneExcludedRegions — 제외를 빼는 자리는 한 곳 (이식 C2)', () => {
    ...
    /** 🔴 도 한 층이 없어서 기사님이 **서울 구 25개를 하나씩** 누르고 계셨다 */
