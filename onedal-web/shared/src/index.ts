...
export interface PendingOrder extends OfficeOrder {
     ...
     *    (이식 B1). 지도가 «구간마다 그 콜의 색»으로 그리려면 경계가 필요한데
     *    통짜 배열은 그것을 잃는다.
     *
 ...
 *    **낭비**다 (에 `destinationGroups` 하나가 응답의 27%였다).
 */
 ...
 *    2026-09-15 부터는 파생 칸도 없다 — 목적지에 도착해 다른 곳을 안 정했으면 그곳 일을 한다.
 ...
 *    관제웹도 지도 폴백에서 같은 판단이 필요해져 shared 로 올렸다 —
 ...
 *    (기사님 확정: *«실험실 계산을 올린다»* · 이식 B3 · 계획서 §4 Q1).
