...
/**
 * 🧾 **누가 이 정거장을 몇 분 밀었나** (기사님).
 *
 * 🔴 **분이 아니라 «시각»을 받는다**. 확정 전 경로와 확정 후
...
/**
 * ✂️ **밀림을 «출발이 밀린 몫»과 «구간이 꺾인 몫»으로 가른다** (기사님 지시:
 * *"①을 갈라 적어"*) — 한 숫자로 적으면 «82분이나 돌아간다»처럼 읽혀 사실을 확인할 수 없다.
 *
 * 아래 숫자는 기사님 화면의 실측 그대로다 (콜 넷 · 파주행).
 */
