...
/**
 * 🚏 **정거장 목록이 바뀌었을 때 걸음 상태** (여섯 번째 바퀴 · onedal-49 짚음).
 *
 * · 비었으면 **들른 장부만** 비운다 — 판마다 좌표가 같은 문제지에서 지난 판에 들른 곳을 «들렀다»로 보지 않게.
 ...
 *  🔄 18 → 12 (여섯 번째 바퀴 · 기사님 «정차가 너무 길다» · onedal-49 제안). 모의 좌표의 도착은 500m 안이면 곧바로라
