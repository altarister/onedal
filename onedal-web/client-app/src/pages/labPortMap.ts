...
// 🔴 `StopImpact` 는 `@onedal/shared` 로 옮겼다 (2026-09-11 · 이식 A3) — 아래에서 다시 내보낸다
...
export const LAB_CALL_TO_ORDERS: Record<string, string | null> = {
    ...
    /**
     * 🧹 **취소·방출로 끝난 시각** — 실물 `orders.terminatedAt` (2026-09-14 · 전수표 #65).
 ...
 *    (2026-09-11 · 이식 A3 · `docs/기획/이식_계획_지도필터콜.md` §8 ①).
