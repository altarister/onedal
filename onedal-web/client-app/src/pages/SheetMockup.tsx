    ...
    return (
        <div>
            <div className="flex items-center gap-1.5 px-3 py-1">
                ...
                {d.stuck && (
                    <span className="min-w-0 truncate text-[10.5px] font-bold text-warning tabular-nums">
                        본 42 · 통과 0 <b>요금12</b>
                    </span>
                )}
...
/**
 * 📱 **폰 판 — 자리값 하는 것만 늘 보인다** (엄선 확정 2026-09-05 · 폰_상태바.md §4-4)
 *
 * ── 관제가 답해야 하는 물음은 셋이다 ──
 ...
 *
 * 🔴 **한 줄에 다 넣으면 116칸인데 폰 한 줄은 56칸이다** (§4-2 실측).
 *    그래서 넷을 접었다 — 누적(20칸) · 버전(16) · 작업 단계(13) · 필터 배지(9).
 *    **그 넷이 한 줄을 두 배로 만들던 몫이다.**
        ...
        <div className="min-h-dvh bg-bg-base text-text-primary flex flex-col items-center
            ...
            <div className="w-full max-w-[560px] px-4 py-5 border-t border-border-card
                ...
                <p className="mt-2 text-[12px] leading-relaxed text-text-muted">
                    ...
                    <br />· 값은 <b className="text-text-primary">높이</b>로 치릅니다 — 한 대 26px · <b className="text-text-primary">세 대 78px</b>
