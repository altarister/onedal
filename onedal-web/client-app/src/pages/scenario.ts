...
export const SCENARIO: ScenarioStep[] = [
    ...
    {
        no: 4, title: '④ 경로를 바꿔 본다', grabbed: 1, visited: 0, phase: '정차', color: '보통',
        what: '기사님이 지도 좌상단에서 「시간」(고속도로 우선)을 누르셨습니다. 서버가 그 방침으로 '
            + '다시 물어 경로가 바뀝니다 — 29.3km에서 33.1km로 멀어지고 km당 단가가 내려가 '
            + '🟢 보통이 됐습니다. 그래도 좋습니다.',
        gap: '「고속도로 우선」이라는 이름의 버튼은 아직 없습니다(지금은 「시간」). 그리고 판정 스냅샷은 '
           + '«심사 1회, 불변»이라 확정 뒤 경로를 바꿔도 지금은 색이 다시 매겨지지 않습니다.',
    },
    {
