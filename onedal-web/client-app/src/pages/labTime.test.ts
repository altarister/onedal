 ...
 *
 * 같은 누적 계산을 여러 곳에 두면 「분끼리 빼는」 같은 버그를 한 곳만 고치고 나머지를 놓친다.
 * `MapMockup.tsx` 는 여기 한 벌을 불러 쓰고, 여기서 잠근다 (규칙 ③).
 */
...
/**
 * 🔢 **방문 순번 — 지도와 시트가 같은 숫자를 말해야 한다** (기사님 실측:
 * 지도 ⑧⑨⑩ ↔ 시트 10·11·12). 세는 곳이 둘이면 번호가 어긋나서 여기서 잠근다.
 */
describe('🔢 방문 순번', () => {
