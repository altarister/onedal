...
/**
 * 🎚️ **눈금을 잘못 두면 «못 보는 것»이 생긴다 — 화면이 그것을 말한다**.
 *
 * 예: 모의 주행 눈금을 **정차 5초**로 두면 «정차» 상태가
 * **구조적으로 한 번도 안 나온다** — 관제웹의 주행/정차 판정이 «5km/h↓ 가 「굳는 시간」만큼
 * 이어져야 정차»라서, 정차 연기가 그보다 짧으면 조건이 성립할 길이 없다.
 * 화면이 그 눈금을 조용히 받으면 기사님은 무엇을 못 보는지 모른 채 시험을 도신다.
 *
