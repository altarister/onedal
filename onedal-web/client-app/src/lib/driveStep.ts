/**
 * 🚗 **한 걸음 — 목업에서 가져온 그대로** (2026-09-12 · 기사님 *"그거 가져오라고 목업에서
 * 열심히 만든거 아냐"*).
 *
 ...
 *    들어간다. 실물 시뮬은 `idx += 15` 로 **건너뛰어서** 카카오 곡선이 직선으로 펴졌다 —
 ...
 *    실물은 한 줄로 이어서, 정거장 좌표를 찍을 때(도로에서 601m 떨어진 물류센터)
 *    **도로 밖으로 튀었다 돌아오는 직선 둘**이 궤적에 남았다.
