...
describe('손이 이긴다 — 그리고 유예가 끝나면 잊지 않는다', () => {
    ...
    /**
     * 🔴 **유예 중에 온 «도착»은 유예가 끝나면 다시 묻는다 — 아직 그 정거장 곁이면** (여섯 번째 바퀴 · onedal-49 합의).
...
/**
 * 🪧 **판정이 손보다 먼저다 · 판정 중에는 손이 높이를 못 바꾼다 · 늦게 열기도 규칙을 지난다** (기사님 2026-09-15).
 *
...
/**
 * 🪜 **비어 있는 「나」는 손으로 끌 때 건너뛴다** (기사님 2026-09-15).
 *
