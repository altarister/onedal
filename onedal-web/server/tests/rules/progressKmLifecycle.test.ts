 ...
 * "상차지가 목록에 없으면 경로 밖 → 차단"한다. 사이클이 끝나 STANDBY 로 돌아온 뒤에도
 * 앞 경로의 detourProgressKm 이 세션에 남아 내려가면(180동 · 178개 null), 첫짐 탐색 중에
 * **앞 경유 목록 밖 상차지의 첫짐 후보가 전부 차단**된다. "앱은 느슨하게 올린다"(규칙 ⑤) 정면 위반.
 *
