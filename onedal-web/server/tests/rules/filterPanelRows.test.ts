...
/**
 * 🧰 **필터 창 — 지도를 보면서 고친다** (기사님 확정 · 목업 https://claude.ai/artifact/RfDCyjwqHM2UcoNGaBTwPy).
 *
 ...
 *
 * 🔴 필터 창은 **내용만큼만** 선다 — 네 행이 모두 닫힌 채 시작하고 **하나만** 열린다. 저장 줄은 스크롤 밖 바닥에 늘 보인다.
 */
...
describe('🧰 필터 판 — 네 행 · 하나만 열림 · 저장 줄 고정', () => {
    ...
    /**
     * 🔴 **필터 창에 필요 없는 것이 없다** (기사님: *"필요 없는거 지우고 폰트 사이즈 맞춰주고 · 지금 너무 공간낭비가 많아"*).
