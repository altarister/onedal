...
/**
 * 🎯 **도착은 «거리»가 정하지 «순서»가 정하지 않는다** (2026-09-12 밤 · 기사님 지시).
 *
 * ── 무엇이 문제였나 ──
 ...
 *    이면 스톱워치 없이 발화해서(2026-09-15 부터는 «서 있다»고 온 틱에), 30초 스톱워치 갈래가 **검사에서 한 번도 안 돈다.**
...
describe('도착 후보 — 순서가 아니라 거리가 정한다', () => {
     ...
     *    순서가 흔들리면 그 차례가 영영 안 올 수도 있다 (2026-09-01 실패).
     */
