 ...
 *
 * 막는 것:
 *   · 같은 번호(4000 같은)가 여러 곳에 흩어져, 바꾸려면 찾아 헤매는 것
 *   · 크롬 조종 포트 범위(`lab` · `shot`)처럼 두 자리의 범위가 **겹치는 것**
 *   · 표에 없는 자리(예: `pnpm dev` 로 함께 뜨는 운행일지 3001)를 점검 도구가 모르는 것
 */
...
/** 주석을 걷는다 — 주석 속 번호는 설명이지 포트를 쓰는 것이 아니다 */
