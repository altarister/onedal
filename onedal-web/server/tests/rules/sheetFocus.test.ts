...
describe('S13·S14·S15 — 마중은 «그 콜의 그 단계»까지다', () => {
    ...
    it('🔴 S13 사건이 가리킨 콜이 이긴다 — 이미 열린 것이 있어도 바꾼다', () => {
         ...
         *    KEEP 때 같은 병을 한 번 고쳤는데 이 줄이 살아 있어 되살아났다.
         */
     ...
     */
    /**
     * 🎬 **시트가 맨 위로 올라가면 시트 상태바가 말하는 «그 콜 · 그 단계»를 연다** (기사님 2026-09-15).
     *
