...
describe('🧭 내비 화면은 좌표를 서버로 보내지 않는다', () => {
    ...
    it('«내비 화면인가»는 주소로 정한다 — 다른 화면은 영향이 없다', () => {
        // 내비 화면이 없어도 **주소 판정은 남긴다** — 새 화면을 만들 때 여기 이어 붙인다
