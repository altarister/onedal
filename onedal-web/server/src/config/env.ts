 ...
 * 🔒 **여기가 라이브인가.**
 *
 * 개발용 우회 로그인(`/api/auth/bypass`) 같은 문은 라이브에서 닫아야 한다 — 열려 있으면 아무나 POST 해
 * 기사님 계정의 관리자 토큰을 받는다. 라이브에는 **집 주소와 실제 운행 기록**이 있다.
 *
