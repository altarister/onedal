 ...
 *    09-13 라이브 오배차 조사에서 **08:22 의 앱 로그가 한 줄도 없었다** — 12:09 에
 *    받은 `main` 버퍼는 **11:51 부터**였다. 그래서 «무슨 콜을 눌렀나»를 끝내 못 짚고,
 *    좌표를 실물 사진에서 눈으로 재야 했다.
 *    `log/1dal-주행로그-20260903/읽어보세요.md` §6 이 이미 *"나가기 전에 비우고 가도
 *    같은 일이 난다 — 앱이 제 파일을 쓰는 수밖에 없다"* 고 적어 두었었다.
 *
